...
public class FormulaireFaceAndEdge : Form
{
    ...
    public FormulaireFaceAndEdge(SolidEdgeFramework.Application application, SolidEdgeFramework.SolidEdgeDocument document, SolidEdgePart.Model model)
    {
